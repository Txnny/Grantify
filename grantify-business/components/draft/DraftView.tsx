...
import { ApplicationDraft, BusinessProfile, ConversationMessage } from '@/lib/types';
...
export default function DraftView({
      ...
      try {
        ...
        const hint =
          ...
          (parseErr.message.includes('truncated') || parseErr.message.includes('likely truncated'))
            ...
            : '';
        setError(`Failed to parse draft response.${hint} Start of response: "${preview}"`);
        return;
      }
  ...
  async function handleExport() {
    ...
    try {
      ...
      a.href = url;
      a.download = `${clientProfile.companyName} - ${clientProfile.grantName}.docx`;
      a.click();
