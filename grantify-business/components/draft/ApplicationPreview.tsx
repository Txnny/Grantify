      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex shrink-0 items-center gap-2">
          ...
          <button
            ...
            className="rounded-md bg-blue-600 px-4 py-2 text-xs font-semibold text-white hover:bg-blue-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
              ...
              <div className="flex items-center gap-3">
                ...
                {editingId !== section.id && (
                  <button
                    ...
                    className="rounded border border-neutral-700 px-2.5 py-1 text-[11px] text-neutral-500 hover:border-blue-500 hover:text-blue-400 transition-colors"
                  >
                    Edit
                  </button>
                )}
      ...
      <div className="sticky bottom-0 flex items-center justify-between rounded-xl border border-neutral-800 bg-neutral-950/90 px-5 py-3 backdrop-blur">
        ...
        <div className="flex gap-2">
          ...
          <button
            onClick={onExport}
            disabled={isExporting}
            className="rounded-md bg-blue-600 px-5 py-2 text-xs font-semibold text-white hover:bg-blue-500 disabled:opacity-50 transition-colors"
          >
            {isExporting ? 'Exporting…' : 'Export .docx'}
          </button>
        </div>
