...
function ScoreBar({ label, value }: { label: string; value: number }) {
  const color =
    value >= 75 ? '#3b82f6' : value >= 50 ? '#2563eb' : '#1d4ed8';
  ...
  return (
    <div className="rounded-xl border border-neutral-700 bg-neutral-900 p-5">
      <div className="flex items-start justify-between gap-6">
        ...
        {/* Overall score */}
        <div className="flex shrink-0 flex-col items-center justify-center rounded-xl border border-[#3b82f6]/30 bg-[#3b82f6]/5 px-6 py-4">
          <span
            className="text-5xl font-bold leading-none text-[#3b82f6]"
